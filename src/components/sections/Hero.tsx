...
const Hero = () => {
  return (
    <section className="hero-section position-relative d-flex align-items-center section-shell">
      ...
      <span className="floating-orb floating-orb--cyan" style={{ top: '16%', right: '9%' }} />
      <span className="floating-orb floating-orb--purple" style={{ bottom: '14%', right: '16%' }} />
        ...
        <Row>
          <Col lg={8} xl={7}>
            ...
            >
              ...
              <h1 className="hero-title display-2 fw-black text-uppercase mb-4" style={{ fontWeight: 900 }}>
                Entrena hoy, presume tu
                <span className="text-neon d-block">Mejor Versión</span>
              </h1>

              <p className="lead text-light mb-5 pe-lg-5" style={{ opacity: 0.92, maxWidth: '600px' }}>
                Convierte la disciplina en resultados reales con una experiencia premium,
                acompañamiento experto y una comunidad que te empuja hacia arriba.
              </p>
              ...
              <div className="d-flex gap-3 gap-md-5 mt-5 pt-4 border-top border-secondary">
                {[
                  ...
                  <div key={metric.label}>
                    <h3 className="h2 fw-bold mb-0 text-white">{metric.value}</h3>
